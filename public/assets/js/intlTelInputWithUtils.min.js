...
(function (factory) {
  ...
  var factoryOutput = (() => {
    ...
    var R2 = (f, e) => {
        for (var n in e) I1(f, n, { get: e[n], enumerable: !0 });
      },
      O2 = (f, e, n, r) => {
        if ((e && typeof e == "object") || typeof e == "function")
          for (let a of P2(e))
            !x2.call(f, a) &&
              ...
              I1(f, a, {
                get: () => e[a],
                enumerable: !(r = D2(e, a)) || r.enumerable,
              });
        return f;
      };
    var k2 = (f) => O2(I1({}, "__esModule", { value: !0 }), f);
    var z2 = {};
    R2(z2, { default: () => W2 });
    var o2 = [
        ["af", "93"],
    ...
    var U2 = { ...a2, ...u2 },
      _1 = U2;
    for (let f = 0; f < K.length; f++) K[f].name = _1[K[f].iso2];
    var H2 = 0,
      c2 = {
        allowDropdown: !0,
      ...
      K2 = (f, e, n, r) => {
        ...
        for (let l = 0; l < e.length; l++) {
          if ((/[+0-9]/.test(e[l]) && a++, a === f && !r)) return l + 1;
          if (r && a === f + 1) return l;
        }
        return e.length;
      },
      T = (f, e, n) => {
        let r = document.createElement(f);
        return (
          e && Object.entries(e).forEach(([a, l]) => r.setAttribute(a, l)),
          n && n.appendChild(r),
          r
        );
      },
      $1 = (f, ...e) => {
        let { instances: n } = m;
        Object.values(n).forEach((r) => r[f](...e));
      },
      b1 = class {
        constructor(e, n = {}) {
          (this.id = H2++),
            ...
            (this.options = Object.assign({}, c2, n)),
        ...
        _init() {
          ...
          let n = new Promise((a, l) => {
              (this.resolveAutoCountryPromise = a),
                (this.rejectAutoCountryPromise = l);
            }),
            r = new Promise((a, l) => {
              (this.resolveUtilsScriptPromise = a),
        ...
        _sortCountries() {
          this.options.countryOrder &&
            ...
            this.countries.sort((e, n) => {
              ...
              if (r) {
                let a = r.indexOf(e.iso2),
                  l = r.indexOf(n.iso2),
                  p = a > -1,
                  y = l > -1;
                if (p || y) return p && y ? a - l : p ? -1 : 1;
              }
        ...
        _addToDialCodeMap(e, n, r) {
          ...
          let a = r !== void 0 ? r : this.dialCodeToIso2Map[n].length;
          this.dialCodeToIso2Map[n][a] = e;
        }
        _processAllCountries() {
          let { onlyCountries: e, excludeCountries: n } = this.options;
          if (e.length) {
            let r = e.map((a) => a.toLowerCase());
            this.countries = K.filter((a) => r.indexOf(a.iso2) > -1);
          } else if (n.length) {
            let r = n.map((a) => a.toLowerCase());
            this.countries = K.filter((a) => r.indexOf(a.iso2) === -1);
        ...
        _generateMarkup() {
          ...
          let {
            ...
            _ = "iti";
          e && (_ += " iti--allow-dropdown"),
            r && (_ += " iti--show-flags"),
            a && (_ += ` ${a}`),
            C || (_ += " iti--inline-dropdown");
          let w = T("div", { class: _ });
          if (
            (this.telInput.parentNode?.insertBefore(w, this.telInput),
            e || r || n)
          ) {
        ...
        _appendListItems() {
          for (let e = 0; e < this.countries.length; e++) {
            ...
            this.options.showFlags &&
              ...
              a.insertAdjacentHTML("beforeend", l);
          }
        }
        ...
        _initRequests() {
          ...
          !e &&
            ...
            r === "auto" && a && !this.selectedCountryData.iso2
          ...
          /\p{L}/u.test(this.telInput.value) && (y = !0),
            (this._handleInputEvent = (C) => {
              if (this.isAndroid && C?.data === "+" && r && l && p) {
                let w = this.telInput.selectionStart || 0,
                  O = this.telInput.value.substring(0, w - 1),
                  M = this.telInput.value.substring(w);
              ...
              let _ = C?.detail && C.detail.isSetNumber && !a;
              if (n && !y && !_) {
                let w = this.telInput.selectionStart || 0,
                ...
                if (
                  ...
                  if (e) {
                    let S = this.telInput.value,
                      ...
                      O = r ? w : _ || w,
                      M =
                        S.slice(0, this.telInput.selectionStart) +
                        C.key +
                        S.slice(this.telInput.selectionEnd),
                      k = this._getFullNumber(M),
                      z = m.utils.getCoreNumber(
                        k,
                      ...
                      n1 = !1;
                    if (I) {
                      let f1 = this.selectedCountryData.iso2;
                      n1 = this._getCountryFromNumber(k) !== f1;
                    }
                    (!O || (Z && !n1 && !_)) && C.preventDefault();
                  }
                }
              }),
        ...
        _bindDropdownListeners() {
          (this._handleMouseoverCountryList = (a) => {
            let l = a.target?.closest(".iti__country");
          ...
          if (
            ((this._handleKeydownOnDropdown = (a) => {
              ["ArrowUp", "ArrowDown", "Enter", "Escape"].includes(a.key) &&
                (a.preventDefault(),
                a.stopPropagation(),
                a.key === "ArrowUp" || a.key === "ArrowDown"
                  ? this._handleUpDownKey(a.key)
                  : a.key === "Enter"
                  ? this._handleEnterKey()
                  : a.key === "Escape" && this._closeDropdown()),
                !this.options.countrySearch &&
                  /^[a-zA-ZÀ-ÿа-яА-Я ]$/.test(a.key) &&
                  (a.stopPropagation(),
                  r && clearTimeout(r),
                  (n += a.key.toLowerCase()),
        ...
        _updateValFromNumber(e) {
          ...
          if (
            ...
            let r =
              ...
              { NATIONAL: a, INTERNATIONAL: l } = m.utils.numberFormat,
              p = r ? a : l;
            n = m.utils.formatNumber(n, this.selectedCountryData.iso2, p);
          }
        ...
        _getCountryFromNumber(e) {
          ...
          let p = this._getDialCode(r, !0),
            y = p1(r);
          if (p) {
            let C = this.dialCodeToIso2Map[p1(p)],
              S =
                C.indexOf(this.selectedCountryData.iso2) !== -1 &&
                y.length <= p.length - 1;
            if (!(a === "1" && h2(y)) && !S) {
              for (let _ = 0; _ < C.length; _++) if (C[_]) return C[_];
            }
          } else {
        ...
        _setCountry(e) {
          let { separateDialCode: n, showFlags: r, i18n: a } = this.options,
          ...
          if (
            ...
            e && r
              ...
              : ((p = "iti__flag iti__globe"), (y = a.noCountrySelected)),
        ...
        _updateMaxLength() {
          ...
          if (e && m.utils)
            if (a) {
              let l = m.utils.numberType[n],
                p = m.utils.getExampleNumber(a, !1, l, !0),
                y = p;
              for (; m.utils.isPossibleNumber(p, a, r); ) (y = p), (p += "0");
              let C = m.utils.getCoreNumber(y, a);
              (this.maxCoreNumberLength = C.length),
                a === "by" && (this.maxCoreNumberLength = C.length + 1);
        ...
        _updatePlaceholder() {
          ...
          if (m.utils && l) {
            let p = m.utils.numberType[n],
              y = this.selectedCountryData.iso2
                ? m.utils.getExampleNumber(this.selectedCountryData.iso2, r, p)
                : "";
            (y = this._beforeSetNumber(y)),
              typeof a == "function" && (y = a(y, this.selectedCountryData)),
        ...
        _updateDialCode(e) {
          ...
          if (n.charAt(0) === "+") {
            ...
            l ? (a = n.replace(l, r)) : (a = r), (this.telInput.value = a);
          }
        }
        _getDialCode(e, n) {
          let r = "";
          if (e.charAt(0) === "+") {
            ...
            for (let l = 0; l < e.length; l++) {
              ...
              if (!isNaN(parseInt(p, 10))) {
                if (((a += p), n))
                  this.dialCodeToIso2Map[a] && (r = e.substr(0, l + 1));
        ...
        _formatNumberAsYouType() {
          let e = this._getFullNumber(),
            n = m.utils
              ? m.utils.formatNumberAsYouType(e, this.selectedCountryData.iso2)
              : e,
            { dialCode: r } = this.selectedCountryData;
        ...
        destroy() {
          ...
          let a = this.telInput.parentNode;
        ...
        getNumber(e) {
          if (m.utils) {
            ...
            return m.utils.formatNumber(this._getFullNumber(), n, e);
          }
          return "";
        }
        getNumberType() {
        ...
        isValidNumber() {
          ...
          if (n > -1) {
            let r = e.substring(0, n),
              a = this._utilsIsPossibleNumber(r),
        ...
        _utilsIsValidNumber(e) {
          return m.utils
            ? m.utils.isValidNumber(e, this.selectedCountryData.iso2)
            : null;
        }
        setCountry(e) {
          let n = e?.toLowerCase(),
      ...
      V2 = (f) => {
        if (!m.utils && !m.startedLoadingUtilsScript) {
          ...
          if (typeof f == "string")
            e = Promise.reject(
              new Error(
                "INTENTIONALLY BROKEN: this build of intl-tel-input includes the utilities module inline, but it has incorrectly attempted to load the utilities separately. If you are seeing this message, something is broken!"
              )
            );
          else if (typeof f == "function")
            try {
              if (((e = f()), !(e instanceof Promise)))
                throw new TypeError(
                  `The function passed to loadUtils must return a promise for the utilities module, not ${typeof e}`
                );
            } catch (n) {
            ...
            return Promise.reject(
              new TypeError(
                `The argument passed to loadUtils must be a URL string or a function that returns a promise for the utilities module, not ${typeof f}`
              )
            );
          return (
            ...
            e
              .then((n) => {
                ...
                if (!r || typeof r != "object")
                  throw typeof f == "string"
                    ? new TypeError(
                        `The module loaded from ${f} did not set utils as its default export.`
                      )
                    : new TypeError(
      ...
      m = Object.assign(
        (f, e) => {
          ...
          return (
            n._init(),
            f.setAttribute("data-intl-tel-input-id", n.id.toString()),
            (m.instances[n.id] = n),
            n
          );
        },
        {
          ...
          getCountryData: () => K,
          getInstance: (f) => {
            let e = f.getAttribute("data-intl-tel-input-id");
    ...
    (function () {
      ...
      function n(d, t) {
        ...
        ($.prototype = t.prototype),
          ...
          (d.sa = function (i, o, s) {
            for (
              var u = Array(arguments.length - 2), h = 2;
              h < arguments.length;
              h++
            )
              u[h - 2] = arguments[h];
            return t.prototype[o].apply(i, u);
          });
      }
      function r(d) {
        let t = [],
      ...
      function i1(d, t) {
        ...
        if (d.l) {
          if (!(t in d.g)) {
            ...
            if ($ != null)
              if (o.l) {
                for (var s = [], u = 0; u < $.length; u++) s[u] = i.h(o, $[u]);
                $ = s;
              } else $ = i.h(o, $);
            return (d.g[t] = $);
          }
      ...
      var O1 = new RegExp("(?:" + R1() + ")$", "i"),
        ...
        E2 = /^\(?\$1\)?$/;
      function k1(d) {
        return 2 > d.length ? !1 : B(L2, d);
      }
      function B1(d) {
        return B(b2, d) ? s1(d, C2) : s1(d, m1);
      }
      function G1(d) {
        var t = B1(d.toString());
        x(d), d.g(t);
      ...
      function U1(d) {
        return d != null && (U(d, 9) != 1 || A(d, 9)[0] != -1);
      }
      function s1(d, t) {
        for (var $ = new L(), i, o = d.length, s = 0; s < o; ++s)
      ...
      N.prototype.format = function (d, t) {
        if (c(d, 2) == 0 && P(d, 5)) {
          var $ = v(d, 5);
          if (0 < $.length) return $;
        }
        ...
        d =
          P(d, 3) && c(d, 3).length != 0
            ...
            : "";
        d: {
          o = A(o, 20).length == 0 || t == 2 ? A(o, 19) : A(o, 20);
          for (var s, u = o.length, h = 0; h < u; ++h) {
            s = o[h];
            var g = U(s, 3);
            if (
              (g == 0 || i.search(c(s, 3, g - 1)) == 0) &&
              ((g = new RegExp(c(s, 1))), B(g, i))
            ) {
              o = s;
              break d;
            }
        ...
        return (
          o != null &&
            ...
            (u = v(u, 4)),
            (i =
              t == 2 && u != null && 0 < u.length
                ? i.replace(s, o.replace(T2, u))
                : i.replace(s, o)),
            t == 3 &&
              ((i = i.replace(
                RegExp(
      ...
      function R(d, t) {
        var $ = d.length;
        return 0 < U(t, 9) && A(t, 9).indexOf($) == -1 ? !1 : B(v(t, 2), d);
      }
      function K1(d, t) {
        if (t == null) return null;
        var $ = v(t, 1);
      ...
      function l1(d, t, $, i) {
        var o = u1($, i),
          s = U(o, 9) == 0 ? A(c($, 1), 9) : A(o, 9);
        if (((o = A(o, 10)), i == 2))
          if (U1(u1($, 0)))
            (d = u1($, 1)),
              U1(d) &&
                ((s = s.concat(U(d, 9) == 0 ? A(c($, 1), 9) : A(d, 9))),
                s.sort(),
                o.length == 0
                  ? (o = A(d, 10))
                  : ((o = o.concat(A(d, 10))), o.sort()));
      ...
      function J(d, t, $) {
        var i = t1(t);
        return (
          (t = v(t, 1)), t in X ? ((t = d1(d, t, e1(t))), l1(d, i, t, $)) : 1
        );
      }
      function j1(d, t) {
      ...
      function W1(d, t, $, i, o, s) {
        if (t.length == 0) return 0;
        t = new L(t);
        var u;
        $ != null && (u = c($, 11)), u == null && (u = "NonMatch");
        var h = t.toString();
        if (h.length == 0) u = 20;
        else if (Q.test(h)) (h = h.replace(Q, "")), x(t), t.g(B1(h)), (u = 1);
        else {
          if (
            ((h = new RegExp(u)), G1(t), (u = t.toString()), u.search(h) == 0)
          ) {
            h = u.match(h)[0].length;
            var g = u.substring(h).match(x1);
            g && g[1] != null && 0 < g[1].length && s1(g[1], m1) == "0"
              ? (u = !1)
              : (x(t), t.g(u.substring(h)), (u = !0));
          } else u = !1;
          u = u ? 5 : 20;
        }
        if ((o && E(s, 6, u), u != 20)) {
          if (2 >= t.h.length) throw Error("Phone number too short after IDD");
          if (((d = j1(t, i)), d != 0)) return E(s, 1, d), d;
        ...
        return $ != null &&
          ...
          (g = t.toString()),
          g.lastIndexOf(h, 0) == 0 &&
            ((h = new L(g.substring(h.length))),
            (g = c($, 1)),
            (g = new RegExp(v(g, 2))),
            z1(h, $, null),
            (h = h.toString()),
            (!B(g, t.toString()) && B(g, h)) ||
              l1(d, t.toString(), $, -1) == 3))
          ? (i.g(h), o && E(s, 6, 10), E(s, 1, u), u)
          : (E(s, 1, 0), 0);
      }
      function z1(d, t, $) {
        var i = d.toString(),
        ...
        if (o != 0 && s != null && s.length != 0) {
          ...
          if ((o = u.exec(i))) {
            ...
            var h = B(s, i),
              g = o.length - 1;
            (t = c(t, 16)),
              t == null || t.length == 0 || o[g] == null || o[g].length == 0
                ? (!h || B(s, i.substring(o[0].length))) &&
                  ($ != null && 0 < g && o[g] != null && $.g(o[1]),
                  d.set(i.substring(o[0].length)))
                : ((i = i.replace(u, t)),
                  (!h || B(s, i)) &&
                    ($ != null && 0 < g && $.g(o[1]), d.set(i)));
          }
        }
      }
      function W(d, t, $) {
        if (!a1($) && 0 < t.length && t.charAt(0) != "+")
          throw Error("Invalid country calling code");
        return Z1(d, t, $, !0);
      }
      function Z1(d, t, $, i) {
        ...
        if (s === -1) s = null;
          ...
          var u = t.indexOf(";", s);
          s = u !== -1 ? t.substring(s, u) : t.substring(s);
        }
        var h = s;
        if (
          (h == null
              ...
              : ((s = o.g),
                ...
                0 <= h
                  ? ((u = u.substring(h)),
                    (u = u.replace(_2, "")),
                    (h = u.search(I2)),
                    0 <= h && (u = u.substring(0, h)))
                  : (u = ""),
                s.call(o, u)),
            (s = o.toString()),
            (u = s.indexOf(";isub=")),
            0 < u && (x(o), o.g(s.substring(0, u))),
            !k1(o.toString())))
        )
          throw Error("The string supplied did not seem to be a phone number");
        if (
          ((s = o.toString()),
          !(a1($) || (s != null && 0 < s.length && Q.test(s))))
        )
          throw Error("Invalid country calling code");
        (s = new H()), i && E(s, 5, t);
        d: {
          if (
            ((t = o.toString()),
            (u = t.search(O1)),
            0 <= u && k1(t.substring(0, u)))
          ) {
            h = t.match(O1);
            for (var g = h.length, G = 1; G < g; ++G)
              if (h[G] != null && 0 < h[G].length) {
                x(o), o.g(t.substring(0, u)), (t = h[G]);
                break d;
              }
          }
          t = "";
        ...
        try {
          ...
          if (v1.message == "Invalid country calling code" && Q.test(g)) {
            if (((g = g.replace(Q, "")), (h = W1(d, g, u, t, i, s)), h == 0))
              throw v1;
          } else throw v1;
        }
        if (
      ...
      function q1(d, t) {
        var $ = d.ga;
        return (t = a1(t) ? V1($, t) : 0), (d = F(d.ga, e1(t))), d ?? Y1;
      }
      function X1(d) {
        for (var t = d.j.length, $ = 0; $ < t; ++$) {
          ...
          if (
            (G.length < g.g.h.length
              ? (g = "")
              : ((g = G.replace(new RegExp(h, "g"), u)),
                (g = g.replace(RegExp("9", "g"), "\u2008"))),
            0 < g.length ? (s.v.g(g), (s = !0)) : (s = !1),
            s)
          )
            return (d.da = o), (d.ha = J1.test(c(i, 4))), (d.$ = 0), !0;
        }
        return (d.u = !1);
      }
      function Q1(d, t) {
        for (var $ = [], i = t.length - 3, o = d.j.length, s = 0; s < o; ++s) {
          ...
          U(u, 3) == 0
            ? $.push(d.j[s])
            : ((u = c(u, 3, Math.min(i, U(u, 3) - 1))),
              t.search(u) == 0 && $.push(d.j[s]));
        }
        d.j = $;
      }
      function M2(d, t) {
        ...
        var $ = t;
        if (
          (x1.test($) || (d.s.h.length == 1 && y2.test($))
            ? (t == "+"
                ? (($ = t), d.ba.g(t))
                : (($ = m1[t]), d.ba.g($), d.g.g($)),
              (t = $))
        ...
        switch (d.ba.h.length) {
          ...
          case 3:
            if (n2(d)) d.ea = !0;
            else return (d.o = $2(d)), y1(d);
          default:
            return d.ea
              ? (i2(d) && (d.ea = !1), d.h.toString() + d.g.toString())
              : 0 < d.j.length
              ? ((t = r2(d, t)),
                ($ = t2(d)),
                0 < $.length
                  ? $
                  : (Q1(d, d.g.toString()),
                    X1(d) ? e2(d) : d.u ? h1(d, t) : d.s.toString()))
              : y1(d);
        }
      }
      function d2(d) {
      ...
      function y1(d) {
        ...
        if (3 <= t.length) {
          for (
            ...
            var s = $[o];
            (0 < d.o.length && H1(v(s, 4)) && !c(s, 6) && !P(s, 5)) ||
              ((d.o.length != 0 || d.ca || H1(v(s, 4)) || c(s, 6)) &&
                A2.test(v(s, 2)) &&
                d.j.push(s));
          }
          return (
            Q1(d, t),
            (t = t2(d)),
            0 < t.length ? t : X1(d) ? e2(d) : d.s.toString()
          );
        }
        return h1(d, t);
      }
      function e2(d) {
        var t = d.g.toString(),
          $ = t.length;
        if (0 < $) {
          for (var i = "", o = 0; o < $; o++) i = r2(d, t.charAt(o));
      ...
      e("intlTelInputUtilsTemp", {}),
        ...
        e("intlTelInputUtilsTemp.isValidNumber", (d, t) => {
          try {
            ...
            var o = v($, 1),
              s = d1(d, o, i);
            if (s == null || (i != "001" && o != V1(d, i))) var u = !1;
            else {
              var h = t1($);
              u = C1(h, s) != -1;
            }
          ...
          try {
            ...
            if ($) {
              ...
              if ($ === "FIXED_LINE_OR_MOBILE") {
                let u = J(i, o, c1.MOBILE) === 0,
                  h = J(i, o, c1.FIXED_LINE) === 0;
                return u || h || s;
              }
              return s;
            }
        ...
        e("intlTelInputUtilsTemp.numberType", c1),
